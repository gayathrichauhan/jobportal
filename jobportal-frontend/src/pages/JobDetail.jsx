...
const JobDetail = () => {
    ...
    const { applyForJob, saveJob, unsaveJob, isJobApplied, isJobSaved, withdrawApplication, getJobByIdSync } = useJobs()
    const { jobs: apiJobs, getJobById } = useJobsData()
    const { user, isAuthenticated, isJobSeeker, isEmployer } = useAuth()

    useEffect(() => {
        // First try to get from API jobs
                                ...
                                <div className="flex items-center space-x-6 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap items-center text-gray-600 dark:text-gray-400 space-x-4 mb-4">
                                            <span className="text-xl font-bold text-primary-600 dark:text-primary-400">{job.company}</span>
                                            <span>•</span>
                          ...
                          🔥 Urgent
                            ...
                            <div className="lg:ml-8 text-center lg:text-right">
                                ...
                                <div className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                                    Posted {getTimeAgo(job.postedDate)} • {job.applicationsCount} applicants
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row lg:flex-col gap-3">
                                    {!isEmployer && (
                                        <>
                                            ...
                                            >
                                                {job && isJobSaved(job.id) ? '❤️ Saved' : (isAuthenticated ? '❤️ Save Job' : '❤️ Login to Save')}
                                            </button>
                                        </>
                                    )}
                                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="bg-white dark:bg-gray-800 backdrop-blur-xl rounded-3xl shadow-lg border-2 border-gray-200 dark:border-gray-700 p-8 mb-8">
                            ...
                            <div className="prose prose-gray dark:prose-invert max-w-none">
                                <div className={`text-gray-700 dark:text-gray-300 leading-relaxed ${!showFullDescription ? 'line-clamp-6' : ''}`}>
                                    {job.description}
                                </div>
                                <button
                                ...
                                >
                                    ...
                                    <svg className={`w-4 h-4 ml-1 transition-transform ${showFullDescription ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="bg-white dark:bg-gray-800 backdrop-blur-xl rounded-3xl shadow-lg border-2 border-gray-200 dark:border-gray-700 p-8 mb-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {job.benefits.map((benefit, index) => (
                                    <div key={index} className="flex items-center space-x-3 p-3 rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="bg-white dark:bg-gray-800 backdrop-blur-xl rounded-3xl shadow-lg border-2 border-gray-200 dark:border-gray-700 p-8 mb-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="text-gray-900 dark:text-white font-semibold">{job.jobType}</div>
                                </div>
                                <div>
                                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Experience Level</div>
                                    <div className="text-gray-900 dark:text-white font-semibold">{job.experienceLevel}</div>
                                </div>
                                <div>
                                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Work Type</div>
                                    <div className="text-gray-900 dark:text-white font-semibold">{job.workType}</div>
                                </div>
                                <div>
                                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Category</div>
                                    <div className="text-gray-900 dark:text-white font-semibold">{job.category}</div>
                                </div>
                                <div>
                                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Remote Available</div>
                                    <div className="text-gray-900 dark:text-white font-semibold">{job.remote ? 'Yes' : 'No'}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Company Info */}
                        <div className="bg-white dark:bg-gray-800 backdrop-blur-xl rounded-3xl shadow-lg border-2 border-gray-200 dark:border-gray-700 p-8 mb-8">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">About {job.company}</h3>
                            <div className="text-center mb-6">
                                ...
                                <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{job.company}</h4>
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between">
                                    ...
                                    <span className="text-gray-900 dark:text-white font-semibold">{job.category}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-500 dark:text-gray-400">Company Size</span>
                                    <span className="text-gray-900 dark:text-white font-semibold">1001-5000</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-500 dark:text-gray-400">Founded</span>
                                    <span className="text-gray-900 dark:text-white font-semibold">2010</span>
                                </div>
                            </div>
                            <Link
